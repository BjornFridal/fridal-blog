...
<a class="bg-pink-100 h-36 rounded flex flex-col leading-none justify-center items-center w-full border-none [&>*]:m-0 gap-y-2" href="https://stackblitz.com/github/BjornFridal/redux-clone/tree/main?file=src%2FApp.jsx" target="_blank">
  <h3 class="font-bold">Will it run?</h3>
  <img class="h-8" src="https://developer.stackblitz.com/img/open_in_stackblitz.svg" alt="Open in StackBlitz" />
